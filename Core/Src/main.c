...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LED_STRIP_1_Pin LED_STRIP_3_Pin LED_STRIP_5_Pin LED_STRIP_7_Pin 
                           LED_STRIP_9_Pin LED_STRIP_11_Pin LED_STRIP_13_Pin LED_STRIP_15_Pin 
  ...
  /*Configure GPIO pins : LED_STRIP_0_Pin LED_STRIP_2_Pin LED_STRIP_4_Pin LED_STRIP_6_Pin 
                           LED_STRIP_8_Pin LED_STRIP_10_Pin LED_STRIP_12_Pin LED_STRIP_14_Pin 
